...
// Функции могут принимать параметрами данные.
//  Для примера давайте сделаем функцию,
...
// Давайте сделаем так,
//     чтобы функция возводила переданное число в квадрат:
// function func(num){
//     console.log(num**2);
// }
// func(5)
...
// и выводит в консоль куб этого числа.
// function func(){
//     console.log(num**2);
// }
// func(2);
...
// //     чтобы в переменную res записывалась дробь,
